    ...
    public partial class MLModel1
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"ocean_proximity", @"ocean_proximity", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=5,MinimumExampleCountPerLeaf=126,NumberOfTrees=52,MaximumBinCountPerFeature=397,FeatureFraction=0.675457086864201,LearningRate=0.999999776672986,LabelColumnName=@"median_house_value",FeatureColumnName=@"Features"}));
